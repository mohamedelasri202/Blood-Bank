    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="donors-list.html" class="text-neutral-600 hover:text-neutral-900 transition-colors text-sm font-medium">Donors</a>
                <a href="recipients-list.html" class="text-neutral-900 font-semibold text-sm">Recipients</a>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tr class="hover:bg-neutral-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-neutral-900">Karim</td>
                        <td class="px-6 py-4 text-sm text-neutral-900">Mansouri</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">+212 6 77 88 99 00</td>
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-600 text-white">Critical</span>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-neutral-600">IJ567890</td>
                        <td class="px-6 py-4">
                    ...
                    Sample Row 2 - Urgent
                    <tr class="hover:bg-neutral-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-neutral-900">Laila</td>
                        <td class="px-6 py-4 text-sm text-neutral-900">Benjelloun</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">+212 6 33 44 55 66</td>
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-500 text-white">Urgent</span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Matched</span>
                        </td>
                        <td class="px-6 py-4 text-sm text-neutral-600">KL123456</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">View</button>
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">Edit</button>
                    ...
                    Sample Row 3 - Normal
                    <tr class="hover:bg-neutral-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-neutral-900">Omar</td>
                        <td class="px-6 py-4 text-sm text-neutral-900">Tazi</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">+212 6 99 88 77 66</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">Male</td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">B+</span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-600 text-white">Normal</span>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-neutral-600">MN789012</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">View</button>
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">Edit</button>
                    ...
                    Sample Row 4 - Urgent
                    <tr class="hover:bg-neutral-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-neutral-900">Nadia</td>
                        <td class="px-6 py-4 text-sm text-neutral-900">Chraibi</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">+212 6 22 33 44 55</td>
                        <td class="px-6 py-4 text-sm text-neutral-600">Female</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-neutral-600">OP345678</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2">
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">View</button>
                                <button class="px-3 py-1.5 text-xs font-medium text-neutral-700 hover:text-neutral-900 hover:bg-neutral-100 rounded transition-all">Edit</button>
